      ...
      if (!context.MenuCourses.Any())
      {
       context.MenuCourses.AddRange(
           // --- 6 Items Sesuai Gambar ---
            ...
            // --- Asian (Lanjutan) ---
            new MenuCourse { Name = "Nasi Goreng Spesial", Image = "Uploads/nasigoreng.svg", Price = 55000, Description = "Fried rice with a mix of egg, chicken, shrimp, and vegetables, served with pickles.", CategoryId = asianCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Ramen Miso", Image = "Uploads/ramen.svg", Price = 75000, Description = "Ramen noodles in a savory miso broth, topped with chicken chashu, a boiled egg, and nori.", CategoryId = asianCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Pad Thai", Image = "Uploads/padthai.svg", Price = 65000, Description = "Stir-fried Thai rice noodles with a sweet and sour sauce, tofu, shrimp, and a sprinkle of peanuts.", CategoryId = asianCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Sate Ayam Madura", Image = "Uploads/sate.svg", Price = 45000, Description = "10 skewers of tender chicken satay with a signature Madura peanut sauce, served with rice cakes (lontong).", CategoryId = asianCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Sushi Platter", Image = "Uploads/sushi.svg", Price = 120000, Description = "A sushi set containing a salmon roll, california roll, and tuna nigiri.", CategoryId = asianCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
