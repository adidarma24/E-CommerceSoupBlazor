      ...
      if (!context.MenuCourses.Any())
      {
       context.MenuCourses.AddRange(
           // --- 6 Items Sesuai Gambar ---
            ...
            // --- Cold Drink (Lanjutan) ---
            new MenuCourse { Name = "Es Kopi Susu Gula Aren", Image = "Uploads/eskopi.jpg", Price = 25000, Description = "A blend of espresso, fresh milk, and the natural sweetness of palm sugar (gula aren).", CategoryId = coldDrinkCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Jus Mangga Segar", Image = "Uploads/jusmangga.jpeg", Price = 30000, Description = "Juice from select 'Harum Manis' mangoes with no added sugar.", CategoryId = coldDrinkCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Lemon Squash", Image = "Uploads/lemonsquash.jpg", Price = 28000, Description = "A refreshing soda drink with real lemon squeeze and a hint of mint leaf.", CategoryId = coldDrinkCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Thai Tea Original", Image = "Uploads/thaitea.jpg", Price = 22000, Description = "Classic Thai black tea mixed with sweetened condensed milk.", CategoryId = coldDrinkCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Es Teh Leci", Image = "Uploads/estehleci.jpg", Price = 26000, Description = "Sweet iced tea with added lychee syrup and refreshing lychee fruit.", CategoryId = coldDrinkCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },

            // --- Cookies (Lanjutan) ---
            new MenuCourse { Name = "Nastar Premium", Image = "Uploads/nastar.jpg", Price = 150000, Description = "Premium cookies filled with homemade pineapple jam, made with a melt-in-your-mouth Wijsman butter dough.", CategoryId = cookiesCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Kaasstengels", Image = "Uploads/kaasstengels.jpg", Price = 165000, Description = "Crispy and savory cheese sticks made using authentic Edam cheese.", CategoryId = cookiesCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Putri Salju", Image = "Uploads/putrisalju.jpg", Price = 135000, Description = "Crescent-shaped cookies dusted with fine powdered sugar, resembling snow.", CategoryId = cookiesCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Lidah Kucing Rainbow", Image = "Uploads/lidahkucing.jpg", Price = 110000, Description = "Thin, crispy 'Cat's Tongue' cookies with an attractive colorful (rainbow) touch.", CategoryId = cookiesCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Oatmeal Raisin Cookies", Image = "Uploads/oatmeal.jpg", Price = 125000, Description = "Healthy and delicious cookies made from oatmeal and sweet raisins.", CategoryId = cookiesCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },

            // --- Dessert (Lanjutan) ---
            new MenuCourse { Name = "Lava Cake Cokelat", Image = "Uploads/lavacake.webp", Price = 55000, Description = "A warm chocolate cake with a molten chocolate center, served with a scoop of vanilla ice cream.", CategoryId = desertCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Panna Cotta", Image = "Uploads/pannacotta.jpg", Price = 45000, Description = "A smooth, creamy Italian pudding served with a fresh strawberry sauce.", CategoryId = desertCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Tiramisu", Image = "Uploads/tiramisu.webp", Price = 65000, Description = "A classic Italian coffee dessert with layers of ladyfingers, mascarpone cheese, and a dusting of cocoa powder.", CategoryId = desertCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Es Pisang Ijo", Image = "Uploads/pisangijo.jpg", Price = 35000, Description = "Banana wrapped in green dough, served with rice flour porridge, syrup, and shaved ice.", CategoryId = desertCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Brownies Panggang", Image = "Uploads/brownies.jpg", Price = 40000, Description = "A slice of rich, dark chocolate baked brownies with an almond topping.", CategoryId = desertCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },

            // --- Eastern ---
            new MenuCourse { Name = "Kebab Daging Sapi", Image = "Uploads/kebab.webp", Price = 45000, Description = "Spiced grilled beef served in a warm pita bread with fresh vegetables.", CategoryId = easternCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Nasi Biryani Ayam", Image = "Uploads/biryani.jpeg", Price = 70000, Description = "Aromatic basmati rice cooked with rich spices and tender chicken pieces.", CategoryId = easternCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Hummus Platter", Image = "Uploads/hummus.jpg", Price = 50000, Description = "Smooth chickpea paste served with olive oil and pita bread.", CategoryId = easternCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Chicken Shawarma", Image = "Uploads/shawarma.jpg", Price = 48000, Description = "A bread wrap filled with sliced grilled chicken, garlic sauce, and pickles.", CategoryId = easternCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Falafel", Image = "Uploads/falafel.jpeg", Price = 40000, Description = "Fried balls made from ground chickpeas, served with tahini sauce.", CategoryId = easternCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Umm Ali", Image = "Uploads/ummali.jpg", Price = 55000, Description = "A rich, traditional Egyptian bread pudding, served warm with a nut topping.", CategoryId = easternCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            
            // --- Hot Drink ---
            new MenuCourse { Name = "Cappuccino", Image = "Uploads/cappuccino.jpeg", Price = 35000, Description = "Espresso with steamed milk, topped with a thick layer of milk foam.", CategoryId = hotDrinkCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Teh Tarik", Image = "Uploads/tehtarik.jpg", Price = 20000, Description = "Strong black tea mixed with milk and 'pulled' (tarik) to create a frothy top.", CategoryId = hotDrinkCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Wedang Jahe", Image = "Uploads/wedangjahe.jpg", Price = 18000, Description = "A traditional ginger drink that warms the body, sweetened with palm sugar.", CategoryId = hotDrinkCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Hot Chocolate", Image = "Uploads/hotchocolate.jpg", Price = 32000, Description = "Premium chocolate melted into warm milk, creating a rich and creamy taste.", CategoryId = hotDrinkCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Matcha Latte", Image = "Uploads/matchalatte.jpg", Price = 38000, Description = "High-quality matcha powder whisked with smooth steamed milk.", CategoryId = hotDrinkCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Kopi Tubruk", Image = "Uploads/kopitubruk.jpg", Price = 15000, Description = "A traditional Indonesian black coffee, brewed directly from fine coffee grounds.", CategoryId = hotDrinkCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },

            // --- Junkfood ---
            new MenuCourse { Name = "Beef Burger Deluxe", Image = "Uploads/burger.jpg", Price = 65000, Description = "A burger with a thick beef patty, cheddar cheese, lettuce, tomato, and a special sauce.", CategoryId = junkfoodCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Kentang Goreng", Image = "Uploads/fries.jpg", Price = 25000, Description = "Crispy french fries sprinkled with salt, served with ketchup.", CategoryId = junkfoodCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Pizza Pepperoni", Image = "Uploads/pizza.jpeg", Price = 95000, Description = "A thin-crust pizza with tomato sauce, mozzarella cheese, and generous pepperoni.", CategoryId = junkfoodCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Ayam Goreng Crispy", Image = "Uploads/friedchicken.jpg", Price = 30000, Description = "One piece of fried chicken with a crispy breading and secret spices.", CategoryId = junkfoodCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Hotdog", Image = "Uploads/hotdog.jpg", Price = 40000, Description = "A soft bun with a grilled beef sausage, mustard, and ketchup.", CategoryId = junkfoodCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Onion Rings", Image = "Uploads/onionrings.jpg", Price = 32000, Description = "Onion rings fried to a perfect crisp with a special batter.", CategoryId = junkfoodCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            
            // --- Western (Lanjutan) ---
            new MenuCourse { Name = "Sirloin Steak", Image = "Uploads/steak.jpg", Price = 185000, Description = "A 200g imported sirloin steak served with mushroom sauce, potatoes, and vegetables.", CategoryId = westernCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Chicken Cordon Bleu", Image = "Uploads/cordonbleu.webp", Price = 95000, Description = "A rolled chicken breast filled with smoked beef and melted cheese, fried until golden brown.", CategoryId = westernCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Fish and Chips", Image = "Uploads/fishnchips.jpg", Price = 75000, Description = "Crispy battered dory fish served with french fries and tartar sauce.", CategoryId = westernCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Caesar Salad", Image = "Uploads/caesarsalad.jpg", Price = 60000, Description = "A salad with romaine lettuce, croutons, parmesan cheese, and caesar dressing.", CategoryId = westernCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new MenuCourse { Name = "Lasagna al Forno", Image = "Uploads/lasagna.jpg", Price = 90000, Description = "Layers of pasta with meat sauce, béchamel sauce, and baked mozzarella cheese.", CategoryId = westernCategory.CategoryId, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow }
        );
        await context.SaveChangesAsync();
      }
